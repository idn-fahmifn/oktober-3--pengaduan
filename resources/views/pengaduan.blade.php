            ...
            <div class="card">
                <div class="card-body w-full p-4">
                    ...
                    <div class="d-flex justify-content-between mt-2 mb-2">
                        ...
                        <button class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#showForm">Buat Laporan</button>
                    </div>
                    <!-- tabel laporan user. -->
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <a class="link-offset-2 link-underline link-underline-opacity-0 text-muted" href="{{route('laporan.show', $item->id)}}">{{$item->judul_laporan}}</a>
                                    </td>
                                    <td>
                                        <!-- jika kategori hilang, akan mengeluarkan notif berwarna merah -->
                                        @if ($item->kategori == 'Kehilangan')
                                        <span class="text-danger">Laporan Kehilangan</span>

                                        <!-- jika tidak, akan mengeluarkan notif berwarna kuning -->
                                        @else
                                        <span class="text-warning">Laporan Kerusakan</span>
                                        @endif
                                    </td>
                                    <td>
